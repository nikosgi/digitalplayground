create table event (id bigint not null auto_increment, name varchar(255) not null, user_id bigint not null, primary key (id))
create table parent (avatar longblob, cellphone varchar(255) not null, country varchar(255) not null, email varchar(255) not null, fathers_name varchar(255) not null, money integer not null, municipality varchar(255) not null, name varchar(255) not null, participation_certificate longblob, pass varchar(255) not null, phone varchar(255) not null, region varchar(255) not null, surname varchar(255) not null, id bigint not null, primary key (id))
...
create table role (role integer not null, id bigint not null, primary key (id))
create table user (id bigint not null auto_increment, email varchar(255) not null, password_hash varchar(255) not null, salt varchar(255) not null, username varchar(255) not null, primary key (id))
...
alter table parent add constraint UK_nf6v1oabf4c9adqqvj6mmoql5 unique (email)
alter table parent add constraint UK_cblsoom23ypq7kpnv7981p71e unique (fathers_name)
...
alter table parent add constraint UK_e0xhsyrmdn5xg5h8xaektxqp5 unique (pass)
...
alter table user add constraint UK_5v2ln3yj7amyuy74guvkp2ibr unique (password_hash)
alter table user add constraint UK_oqm7ghdjhag2ovumjblrnaavb unique (salt)
